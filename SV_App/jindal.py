...
def pred_jindal():
    ...
    # ========================
    try:
        m_path=r"D:\Vasu\MP HMR\Models\trained_model_Jindal.h5"
    ...
    try:
        xp_path=r"D:\Vasu\MP HMR\Pfiles\scaler_X_Jindal.pkl"
    ...
    try:
        yp_path=r"D:\Vasu\MP HMR\Pfiles\scaler_y_Jindal.pkl"
    ...
    # ========================
    historical_file = 'historical_data_jindal.csv'

    if not os.path.isfile(historical_file):
        print(f"'{historical_file}' not found. Creating it from 'Jindal-Stock.csv'.")
        data_path="D:\Vasu\MP HMR\Data\Jindal-Stock_data.csv"
