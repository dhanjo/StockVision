...
def pred_MRF():
    ...
    # ========================
    try:
        m_path=r"D:\Vasu\MP HMR\Models\trained_model_MRF.h5"
    ...
    try:
        xp_path=r"D:\Vasu\MP HMR\Pfiles\scaler_X_MRF.pkl"
    ...
    try:
        yp_path=r"D:\Vasu\MP HMR\Pfiles\scaler_y_MRF.pkl"
    ...
    # ========================
    historical_file = 'historical_data_MRF.csv'

    if not os.path.isfile(historical_file):
        print(f"'{historical_file}' not found. Creating it from 'MRF-Stock.csv'.")
        data_path="D:\Vasu\MP HMR\Data\MRF_Stock_data.csv"
