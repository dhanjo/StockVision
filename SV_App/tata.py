...
def pred_tata():
    ...
    # ========================
    try:
        m_path=r"D:\Vasu\MP HMR\Models\trained_model_TATA.h5"
    ...
    try:
        xp_path=r"D:\Vasu\MP HMR\Pfiles\scaler_X_TATA.pkl"
    ...
    try:
        yp_path=r"D:\Vasu\MP HMR\Pfiles\scaler_y_TATA.pkl"
    ...
    # ========================
    historical_file = 'historical_data_tata.csv'

    if not os.path.isfile(historical_file):
        print(f"'{historical_file}' not found. Creating it from 'Tata-Stock.csv'.")
        data_path="D:\Vasu\MP HMR\Data\Tata-Motors-Data.csv"
