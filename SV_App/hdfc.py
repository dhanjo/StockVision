...
def pred_hdfc():
    ...
    # ========================
    try:
        m_path=r"D:\Vasu\MP HMR\Models\trained_model_HDFC.h5"
    ...
    try:
        xp_path=r"D:\Vasu\MP HMR\Pfiles\scaler_X_HDFC.pkl"
    ...
    try:
        yp_path=r"D:\Vasu\MP HMR\Pfiles\scaler_y_HDFC.pkl"
    ...
    # ========================
    historical_file = 'historical_data_hdfc.csv'

    if not os.path.isfile(historical_file):
        print(f"'{historical_file}' not found. Creating it from 'HDFC-Stock.csv'.")
        data_path="D:\Vasu\MP HMR\Data\HDFC-Stock.csv"
